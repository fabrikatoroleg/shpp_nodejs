/**
  ...
  */
export function AbstractProduct(ID = "", name = "", description = "", price = 0.0, quantity = 0, reviews = [], images = [], date = new Date(), brand = "") {
...
*/
AbstractProduct.prototype.getMyProperty = function (propertyName) {
...
*/
AbstractProduct.prototype.setMyProperty = function (propertyName, value) {
    if (this.hasOwnProperty(propertyName)) {
...
AbstractProduct.prototype.getMyID = function () {
    return this.ID;
}
AbstractProduct.prototype.setMyID = function (newID) {
...
AbstractProduct.prototype.getMyName = function () {
    return this.name;
}
AbstractProduct.prototype.setMyName = function (newName) {
...
AbstractProduct.prototype.getMyDescription = function () {
    return this.description;
}
AbstractProduct.prototype.setMyDescription = function (newDescription) {
...
AbstractProduct.prototype.getMyPrice = function () {
    return this.price;
}
AbstractProduct.prototype.setMyPrice = function (newPrice) {
...
AbstractProduct.prototype.getMyBrand = function () {
    return this.brand;
}
AbstractProduct.prototype.setMyBrand = function (newBrand) {
...
AbstractProduct.prototype.getMyQuantity = function () {
    return this.quantity;
}
AbstractProduct.prototype.setMyQuantity = function (newQuantity) {
...
AbstractProduct.prototype.getMyDate = function () {
    return this.date;
}
AbstractProduct.prototype.setMyDate = function (newDate) {
...
AbstractProduct.prototype.getMyReviews = function () {
    return this.reviews;
}
AbstractProduct.prototype.setMyReviews = function (newReviews) {
...
AbstractProduct.prototype.getMyImages = function () {
    return this.images;
}
AbstractProduct.prototype.setMyImages = function (newImages) {
...
AbstractProduct.prototype.getImage = function (parameter) {
...
*/
AbstractProduct.prototype.toFormattedString = function () {
